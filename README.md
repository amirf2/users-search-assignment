...
### delete user by id:
I retrieve all the relevant user information (name, country, dob) from the userMapByID, which was used as keys in the data structures, and then removed all other references.
